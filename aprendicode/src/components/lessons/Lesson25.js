...
export class Lesson25 extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="lesson boxes">
                        <div className="lesson-box top">
                            <div className="lesson-sublessons">
                                ...
                                <Link to="/lesson25" className="lessons-link selected"><div className="sublesson selected" onClick={this.reloadDataCamp}>Posición</div></Link>
                            ...
                            <div className="lesson-info">
                                <h3 className="lesson-info-title">Lección 2-5</h3>
                                <div id="lesson-info-data">
                                <div className="lesson-info-text">
                                    <p>Si quieres hacer lo contrario y ver qué letra está en la posición 7.</p>
                                </div>
                                </div>
                            </div>
