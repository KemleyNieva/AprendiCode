                    ...
                    <div className="lesson boxes">
                        <div className="lesson-box top">
                            <div className="lesson-sublessons">
                                ...
                                <Link to="/lesson15" className="lessons-link selected"><div className="sublesson selected" onClick={this.reloadDataCamp}>Actualizar Variables</div></Link>
                            ...
                            <div className="lesson-info">
                                <h3 className="lesson-info-title">LEARN - Lección 1-5</h3>
