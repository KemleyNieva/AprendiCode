...
export class Lesson26 extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="lesson boxes">
                        <div className="lesson-box top">
                            <div className="lesson-sublessons">
                                ...
                                <Link to="/lesson26" className="lessons-link selected"><div className="sublesson selected" onClick={this.reloadDataCamp}>Cuenta</div></Link>
                            ...
                            <div className="lesson-info">
                                <h3 className="lesson-info-title">Lección 2-6</h3>
                                <div id="lesson-info-data">
                                <div className="lesson-info-text">
                                    <p>Si desea comprobar si hay letras repetidas en un nombre</p>
                                </div>
                                </div>
                            </div>
